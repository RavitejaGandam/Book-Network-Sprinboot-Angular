...
export class BookService extends BaseService {
  ...
  static readonly BorrowBookPath = '/books/borrowBook/{book-id}';
  ...
  static readonly UpdateArchivedStatusPath = '/books/archivedStatus/{book-id}';
  ...
  static readonly FindAllReturnedBooksPath = '/books/returnedBooks';
  ...
  static readonly FindAllBooksByOwnerPath = '/books/ownerBooks';
  ...
  static readonly FindAllBooksPath = '/books/getAllBooks';
  ...
  static readonly FindAllBorrowedBooksPath = '/books/borrowedBooks';
